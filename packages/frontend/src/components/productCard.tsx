...
import { ProductModel } from "../services/product/types";
import { useAppDispatch } from "../store";
import { addProductToCart } from "../services/product/productSlice";
        ...
        <div className="pt-6">
          ...
          <div className="mt-4 flex items-center justify-between gap-4">
            ...
            <button
              type="button"
              onClick={() =>
                dispatch(addProductToCart({ id: product.id, amount: 1 }))
              }
